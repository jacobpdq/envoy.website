          ...
          if( isset( $this->request->query['error'] ) ){
            if( $this->request->query['error'] == '201' || $this->request->query['error'] == '999' ){      
              ...
              if( $this->request->query['error'] == '201' ) { 
				...
				echo (( 'If you have forgotten your password, please <a href="/agent/password/forgot">click here</a> to reset.<br/><br/>If you are having multiple issues accessing the website then <a href="mailto:mail@envoynetworks.ca">click here to submit a support request</a>.'));
