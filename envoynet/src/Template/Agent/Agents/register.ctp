<div class="inner-content-wrapper">
  <div id="profile_info">
    ...
    <div class="form_content_field_left">
      <div class="User_Name_Form_Holder Base_txt"><label for="company"><span class="Base_red_form_txt"><em>*</em></span>Company name:</label></div>
    ...
    <div class="form_content_field_left">
      <div class="User_Name_Form_Holder Base_txt">First name:</div>
      <?php echo $this->Form->input('firstname', array('label' => false, 'div' => 'blank_form_holder_bg2', 'class' => 'Form_holder_style2')); ?>
    </div>

    <div class="form_content_field_left">
      <div class="User_Name_Form_Holder Base_txt">Last name:</div>
    ...
    <div class="form_content_field_left">
      <div class="User_Name_Form_Holder Base_txt">Email:</div>
