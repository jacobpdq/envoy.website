 ...
 *
 */
class AgentTiersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'tier' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'agent_id' => 1,
            'supplier_id' => 1,
            'tier' => 'Lorem ipsum dolor sit amet'
        ],
    ];
}
