...
/**
 * BrochureOrderAmtsFixture
 *
 */
class BrochureOrderAmtsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'tier' => ['type' => 'string', 'length' => 1, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'brochure_id' => 1,
            'tier' => 'Lorem ipsum dolor sit ame',
            'quantity' => 1
        ],
    ];
}
